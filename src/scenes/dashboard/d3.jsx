    ...
    <Grid container spacing={1} style={{ maxWidth: "100%", marginLeft: "0px" }}>
      <Grid item xs={12} sm={6} md={4}>
        <Box className={classes.topBlock} style={styles}>
          <CardContent>
            <SwitchTemp
              ...
              gradient={props.data.v47}
              ambient={props.data.v4}
              range={props.data.v5}
              deviceStatus={props.data.v6}
              cerror={props.data.v7}
              merror={props.data.v8}
              whpkm={props.data.v38}
            />
          </CardContent>
        </Box>
        <Box className={classes.bottomBlock} style={styles}>
          <CardContent>
            <SpeedTemp
              speed={props.data.v39}
              rpm={props.data.v40}
              odo={props.data.v41}
              cfan={props.data.v42}
              mfan={props.data.v43}
              fner={props.data.v44}
              mtemp={props.data.v46}
              ctemp={props.data.v45}
            />
          </CardContent>
        </Box>
      </Grid>
