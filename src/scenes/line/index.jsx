    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `${colors.palette[50]}/api/brush?fileName=${downloaddate}&userName=${props.user}`
        );
          ...
          <Box sx={{ minWidth: 120, margin: '8px 5px' }} key={index}>
            <FormControl fullWidth sx={{ borderColor: 'green' }}>
              ...
              <Select
                ...
                sx={{ color: 'white' }}
              >
                <MenuItem value={'v1'}>var1</MenuItem>
                <MenuItem value={'v2'}>var2</MenuItem>
                <MenuItem value={'v3'}>var3</MenuItem>
                <MenuItem value={'v4'}>var4</MenuItem>
                <MenuItem value={'v46'}>var46</MenuItem>
              </Select>
            </FormControl>
          </Box>
        ))}
