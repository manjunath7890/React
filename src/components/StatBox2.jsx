...
import LinearGauge from "./Linear";
...
const StatBox = (props) => {
  ...
  return (
    <Box  width={'100%'} justifyContent={'center'}>
      <SemiCircleRadialGauge val={(props.val.var4)/10} value={(props.val.var4) * 2.22}  label={`${props.val.var9}`} colorBlue={colors.primary[300]} colorGrey={colors.grey[100]} colorGreen={colors.greenAccent[500]}/>    
      ...
      >
        ...
        <Box sx={{mb:'0px'}} display={'flex'} alignItems={'center'}>
          ...
          <LinearGauge value={props.val.var12} min={0} max={100} width={10} height={60} color1={colors.greenAccent[500]} color2={colors.primary[300]} />
          <Box color={colors.grey[100]} fontSize={'25px'} fontWeight={'bold'} ml={'5%'}>
            {(props.val.var12)}{'°C'}
          </Box>
        </Box>
